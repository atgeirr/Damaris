...
/*
		...
		int32_t* start_y, int32_t* end_y, int32_t* start_x, int32_t* end_x)
	{
		...
		*lptr = (int64_t)(new Damaris::Layout((Damaris::Types::basic_type_e)(*type),(int32_t)3,args));
		...
		int32_t* start_x, int32_t* end_x)
	{
		...
		args[2] = (int64_t)(*start_y);
		args[3] = (int64_t)(*end_y);
		*lptr = (int64_t)(new Damaris::Layout((Damaris::Types::basic_type_e)(*type), (int32_t)2,args));
		...
		(int64_t* lptr, int32_t* type, int32_t* start_x, int32_t* end_x)
	{
		...
		args[0] = (int64_t)(*start_x);
		args[1] = (int64_t)(*end_x);
		*lptr = (int64_t)(new Damaris::Layout((Damaris::Types::basic_type_e)(*type), (int32_t)1,args));
	...
	{
		*lptr = (int64_t)(new Damaris::Layout((Damaris::Types::basic_type_e)(*type),(int32_t)0));
		return 0;
	}
