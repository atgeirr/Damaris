...
#ifndef CXX_HOME_JBOWDEN_ACROSS_WP7_SRCBUILD_DOWNLOADDEPS_DAMARIS_DEVELOPMENT_SRC_MODEL_MODEL_HPP
#define CXX_HOME_JBOWDEN_ACROSS_WP7_SRCBUILD_DOWNLOADDEPS_DAMARIS_DEVELOPMENT_SRC_MODEL_MODEL_HPP
...
namespace damaris
{
  namespace model
  {
    ...
    class DeprecatedCores: public ::xml_schema::type
    {
      ...
      void
      clients (::std::unique_ptr< clients_type > p);
      ...
      DeprecatedCores (::std::unique_ptr< clients_type >,
                       const count_type&);
    ...
    class Architecture: public ::xml_schema::type
    {
      ...
      void
      domains (::std::unique_ptr< domains_type > p);
      ...
      void
      queue (::std::unique_ptr< queue_type > p);
    ...
    class Layout: public ::xml_schema::string
    {
      ...
      void
      global (::std::unique_ptr< global_type > p);
      ...
      void
      ghosts (::std::unique_ptr< ghosts_type > p);
    ...
    class Variable: public ::xml_schema::string
    {
      ...
      void
      centering (::std::unique_ptr< centering_type > p);
    ...
    class Event: public ::xml_schema::type
    {
      ...
      void
      execution (::std::unique_ptr< execution_type > p);
    ...
    class ParaViewParam: public ::xml_schema::type
    {
      public:
      // script
      //
    ...
    class Log: public ::xml_schema::type
    {
      ...
      void
      LogFormat (::std::unique_ptr< LogFormat_type > p);
      ...
      typedef ::xsd::cxx::tree::traits< Flush_type, char > Flush_traits;
    ...
    class Simulation: public ::xml_schema::type
    {
      ...
      void
      architecture (::std::unique_ptr< architecture_type > p);
      ...
      void
      storage (::std::unique_ptr< storage_type > p);
      ...
      void
      visit (::std::unique_ptr< visit_type > p);

      // paraview
      //
      typedef ::damaris::model::ParaViewParam paraview_type;
      typedef ::xsd::cxx::tree::optional< paraview_type > paraview_optional;
      typedef ::xsd::cxx::tree::traits< paraview_type, char > paraview_traits;

      const paraview_optional&
      paraview () const;
      ...
      void
      paraview (::std::unique_ptr< paraview_type > p);
...
#endif // CXX_HOME_JBOWDEN_ACROSS_WP7_SRCBUILD_DOWNLOADDEPS_DAMARIS_DEVELOPMENT_SRC_MODEL_MODEL_HPP
